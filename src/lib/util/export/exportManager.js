 ...
 */
export const nonStylesheetTypes = ["json"];
/**
 * The global target file type. This can be used to access export configurations
 */
export const targetFileType = writable("css");
/**
 ...
 */
export const exportConfigs = writable(defaultConfigs); // type inference works properly
export const exportTextFile = async (fileName, fileType, content) => {
