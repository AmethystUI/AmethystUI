type callback = () => void; // this callback should only execute procedurally

export default async function flipAnimate(transitionElement: HTMLElement, action: callback, duration = 1000, customCleanup?: callback){
    ...
    let initialBoundingBox: DOMRect;
    let finalBoundingBox: DOMRect;
