...
export let initialColl = writable([]); // the project file data
export let collection = writable([]); // the project file data
export let selectedComponent = writable(-1);
export let selectedOverride = writable(-1);
export let focusedComponent = writable(-1); // this is for detecting delete
export let focusedOverride = writable(-1); // this is for detecting delete
export let layerDeleteLock = writable(false); // this is for locking the delete function. If this is true, you can't delete
export let layerBlurLock = writable(false); // this is for locking the blur function. If this is true, you can't blur
/**
 ...
 */
export const addComponent = (type, defaultStyle = {}, showOutline = true) => {
 ...
 */
export const addOverride = (elmntIndex) => {
    let currCollection = get(collection);
