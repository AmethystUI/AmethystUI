...
const generateIoTsValidator = (type) => {
...
export const startImport = async () => {
    ...
    const fileUploadInput = fileUploadContainer.querySelector("#fileUpload");
    fileUploadInput.onchange = async () => {
        ...
        if (selectedFile) {
            try {
                ...
                if (_project.decode(parsedData)._tag !== "Right")
