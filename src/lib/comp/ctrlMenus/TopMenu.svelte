...
<script lang="ts">
    import FileNameEditor from "$lib/comp/ctrlMenuItems/FileNameEditor.svelte";
    import GeneralAppControl from "$lib/comp/ctrlMenuItems/GeneralAppControl.svelte";
    import DropdownControl, { type menuItem } from "$lib/comp/ctrlMenuItems/GeneralAppControl/DropdownControl.svelte";
    import { defaultMouseDownAction } from "$src/App.svelte";
